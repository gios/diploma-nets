...
app.use(function (ctx, next) { return __awaiter(_this, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!(ctx.path.split('/')[1] !== 'api')) return [3, 2];
                return [4, send(ctx, 'index.html', { root: __dirname + '/../public' })];
            case 1:
                _a.sent();
                return [3, 4];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                ctx.body = { status: ctx.status, message: err_1.message || 'Internal server error' };
