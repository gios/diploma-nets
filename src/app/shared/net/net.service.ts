...
export class NetService {
  ...
  getLinkedConnections() {
    return [
      ...
      link(Ingredient1, CT1, { label: this.randomNumbers() }),
      link(Ingredient2, CT2, { label: this.randomNumbers() }),
      link(Ingredient2, CT3, { label: this.randomNumbers() }),
      link(Ingredient3, CT1, { label: this.randomNumbers() }),
      link(Ingredient4, CT1, { label: this.randomNumbers() }),
      link(Ingredient5, CT1, { label: this.randomNumbers() }),
      link(Ingredient6, CT2, { label: this.randomNumbers() }),
      link(Ingredient6, CT3, { label: this.randomNumbers() }),

      link(CT1, Construction1, { label: this.randomNumbers() }),
      link(CT2, Construction2, { label: this.randomNumbers() }),
      link(CT3, Construction3, { label: this.randomNumbers() }),
      ...
      link(ST1, Shop1, { label: this.randomNumbers() }),
      link(ST2, Shop2, { label: this.randomNumbers() }),
      link(ST3, Shop3, { label: this.randomNumbers() }),
      link(ST4, Shop4, { label: this.randomNumbers() }),
